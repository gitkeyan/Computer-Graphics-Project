...
struct Ray3D {
	...
	void setRayStyle(char part, int ambient_enabled, int diffuse_enabled, int specular_enabled,
		...
		this->part = part; 
		this->ambient_enabled = ambient_enabled; 
		this->diffuse_enabled = diffuse_enabled; 
		this->specular_enabled = specular_enabled;
		this->recursive_ray_enabled = recursive_ray_enabled; 
		this->hard_shadow_enabled = hard_shadow_enabled;
		this->anti_aliasing_enabled = anti_aliasing_enabled; 
		this->soft_shadow_enabled = soft_shadow_enabled;
	}
